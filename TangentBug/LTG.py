...
class AugmentedSubGraph:
    def __init__(self, obstacles, current_location, target):
    ...
    def is_source_local_minima(self):
        lowest_distance_vertex = self.get_closet_point_to_target()
        return lowest_distance_vertex == self._current_location
